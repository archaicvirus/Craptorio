...
inv = make_inventory()
inv.slots[91].item_id = 5
inv.slots[92].item_id = 6
inv.slots[93].item_id = 7
inv.slots[94].item_id = 8
...
function get_visible_ents()
  vis_ents = {['transport_belt'] = {}, ['inserter'] = {}, ['power_pole'] = {}, ['splitter'] = {}, ['dummy'] = {}, ['mining_drill'] = {}}
  for x = 1, 31 do
    for y = 1, 18 do
...
function add_drill(x, y)
  ...
  for i = 1, 4 do
    ...
    if i == 4 and #found_ores == 0 then
      sfx(5, 'C-3', 22, 0, 15, 4)
      return
    end
  end

  -- for key, value in pairs(tile_keys) do
  --   if value ~= 0 then
  --     --TODO > make function to generate ore tile based on distance, richness, etc
  --     if not ORES[key] then
  --       local ore = {
  --         type = ores[value].name,
  --         tile_id = ores[value].tile_id,
  --         sprite_id = ores[value].sprite_id,
  --         ore_remaining = 5,
  --         wx, wy = 
  --       }
  --       ORES[key] = ore
...
function draw_cursor()
  ...
  elseif cursor.type == 'item' and cursor.item == 'burner_miner' then
    ...
    for i = 1, 4 do
      ...
      if ENTS[key] or tile.tile < 5 then
        color_keys[i] = {0, 5}
      end
    end
...
function place_tile(x, y, rotation)
  ...
  elseif cursor.item == 'splitter' then
    add_splitter(x, y)
  elseif cursor.item == 'burner_miner' then
    add_drill(x, y)
  end
end
...
function remove_tile(x, y)
  ...
  if ENTS[key] then
    ...
    elseif ENTS[key].type == 'splitter' or ENTS[key].type == 'dummy' then
      remove_splitter(x, y)
    elseif ENTS[key].type == 'mining_drill' then
      remove_drill(x, y)
    end
  end
...
-- 001:66666666666666666666de666666cdc666666cd6666666666666666666666666
-- 002:6666666666665666566576666767766567677676676776766666666666666666
-- 003:6666666666d666666d2d66d666d66d2d667666d6667666766666666666666666
-- 004:66666666666666666666666666666b666666bab666666b666666676666666666
-- 005:666a666666a4a666666a66666667666666676666666766666666666666666666
-- 006:6666666665666666667664666676766666767666666666666666666666666666
-- 007:666666666666666666eddd666eddddd66ccdcdc666ccce666666666666666666
...
-- 041:61f661661116f11ff1166f1166666666116661f61f1611116116f11f66666166
...
-- 065:66666666666666666666666666666666de666666ddeee666dddddee6dddddcd6
-- 066:666666666666666666eddd666eddddd66ccdcdc666ccce666666666666666666
-- 067:66666666666cd66666edc66666dc666666666666666666666666666666666666
-- 080:6cccdddd66cecccc66cccccc6666ccec66666666666666666666666666666666
-- 081:dccccdd6eddddcc6cccccc66cccec66666666666666666666666666666666666
-- 082:666de66666ddc6666dddce666dddce666dddce666dddcce66ddddcc666dddd66
-- 083:666666666666666666eeeee6cddcccceddddcccc6dddddcc66ddddd666666666
...
-- 128:005777570577577700777777775755770757777707577775007770770000005c
-- 129:5777750077577770777577505777770075757755777770707575000070000000
-- 144:000000cd000000cc000000ee000000dc000000ce000000de000000de000000ed
-- 145:d0000000c0000000d0000000c0000000d0000000e0000000d0000000c0000000
-- </TILES>
...
-- 129:000ee000000cc000000ee000000cc000ddceeddd000cc000000ee000000cc000
...
-- 145:000ee000000cc000000ee000000cc000000ee00000dccd000d4ee4d0edc44cde
...
-- <FLAGS>
-- 000:
-- </FLAGS>
