...
Added 90deg curves to the belts, again as in the original game. The snapping/curved behavior has been replicated, as well as the lane priority system, or preference to deposit items to specific other belt lanes depending on both belts rotation. The lane-priority-rotational-preferences also apply to the inserters when depositing items onto a belt.
